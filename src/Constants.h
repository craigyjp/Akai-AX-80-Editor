...
const String factoryKL[32] = {
  ...
  "Toy Piano, 4, 0, 0, 0, 1, 99, 36, 47, 2, 0, 72, 1, 99, 70, 6, 0, 57, 0, 99, 16, 0, 0, 4, 0, 81, 0, 3, 0, 44, 0, 1, 1, 1, 39, 0, 25, 71, 0, 0, 0, 0, 48, 1, 57, 77",
  ...
  "Solo Synth, 16, 2, 55, 7, 0, 64, 36, 50, 0, 0, 0, 1, 16, 36, 42, 72, 44, 1, 10, 4, 33, 0, 2, 3, 28, 0, 4, 0, 99, 15, 2, 1, 0, 74, 69, 0, 7, 0, 63, 39, 16, 0, 1, 0, 70",
